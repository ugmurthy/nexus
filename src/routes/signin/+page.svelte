<script lang="ts">
  import { Mail, Lock, Eye, EyeOff, Zap, Github } from "lucide-svelte";
...
<svelte:head>
  <title>Sign In — NEXUS AI</title>
  <meta name="description" content="Sign in to your NEXUS AI account" />
</svelte:head>
  ...
  <div class="relative z-10 w-full max-w-md mx-4 animate-slide-up">
    ...
    <div class="glass rounded-3xl p-8 glow-cyan">
      ...
      <div class="flex items-center gap-4 my-6">
        ...
        <span class="text-sm text-slate-500">or continue with</span>
        <div class="flex-1 h-px bg-slate-800"></div>
      </div>
      ...
      <div class="grid grid-cols-2 gap-4">
        <button
          type="button"
          class="flex items-center justify-center gap-2 py-3 glass rounded-xl hover:border-cyan-500/30 transition-colors"
        >
      ...
      <div class="text-center mt-8">
        <p class="text-sm text-slate-400">
          ...
          <a
            href="/signup"
            class="text-gradient font-medium hover:opacity-80 transition-opacity ml-1"
          >
            Get Started
          </a>
        </p>
